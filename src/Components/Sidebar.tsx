...
const navItems: NavItem[] = [
  ...
  { label: "Live Consultations", icon: <Video size={20} />, to: "/consultations" },
  ...
  return (
    <aside className="bg-white text-slate-600 w-full h-full flex flex-col border-r border-slate-100 shadow-sm">
      ...
      <div className="p-4 border-t border-slate-50 mt-auto">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-3 px-4 py-3 text-sm font-bold rounded-xl text-primary hover:bg-secondary transition-all duration-300 mt-1"
        >
          <LogOut size={20} />
          <span>Logout</span>
        </button>
